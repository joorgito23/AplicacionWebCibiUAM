  ...
  <div id="formulario-alta-usuario">
    <form @submit.prevent="altaUsuario">
      ...
      <div class="row justify-content-center align-items-stretch">
        <!-- Usuario -->
        <div class="col-lg-5 col-11 d-flex flex-column mb-3 h-100">
          <label class="align-self-start">
      ...
      <div class="row justify-content-center align-items-stretch">
        ...
        <div class="col-lg-5 col-11 d-flex flex-column mb-3 h-100">
          ...
          <div class="req-list mt-1">
            <span class="req" :class="/^\d{9}$/.test(persona.tlf) ? 'ok' : 'fail'">
              <span class="req-icon">
                {{ /^\d{9}$/.test(persona.tlf) ? "✓" : "✗" }}
              </span>
              9 dígitos
            </span>
          </div>
