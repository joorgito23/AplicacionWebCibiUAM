    ...
    <div class="filtros-panel">
      <div class="filtros-grid">
        ...
        <div class="filtro-grupo">
          ...
          <select v-model="filtros.tarifa" class="filtro-select" data-cy="select-tarifa">
      ...
      <div class="filtros-footer">
        ...
        <button class="btn-filtrar" @click="filtrarContratos" data-cy="filtrar-boton">
...
// Función que limpia los filtros establecidos por el gestor
const limpiarFiltros = () => {
  filtros.value.tarifa = "";
